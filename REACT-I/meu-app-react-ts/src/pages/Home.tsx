        ...
        <Fragment>
           <Banner>
                <div>
                    ...
                    <Button $type='banner'>Learn more</Button>
                </div>
           </Banner>
           ...
           <Container $display='block'>
                ...
                <Container $display='flex' $justifyContent='center' $wrap $fluid >
                    <Card>
                        ...
                        <Button $type='card'>Learn more</Button>
                    </Card>
                    <Card>
                ...
                <Container $display='flex' $direction='row' $alignItems='center' $justifyContent='space-evenly' $wrap $reverse>
                    <Wrapper>
                        <h2>
